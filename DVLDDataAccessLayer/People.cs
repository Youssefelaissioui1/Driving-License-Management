...
namespace DVLDDataAccessLayer
{
    public class People
    {
        public static bool GetInfoByPersonID(int PersonID,ref string NationalNo, ref string FirstName, ref string SecondName, ref string ThirdName, ref string LastName,
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (reader["DateOfBirth"] != DBNull.Value)
                        ...
                        DateOfBirth = DateTime.MinValue; // ou autre valeur par défaut
                    Gender = reader["Gender"] != DBNull.Value ? Convert.ToInt32(reader["Gender"]) : 0;
        ...
        public static bool GetInfoByPersonNationalNo(ref int PersonID,  string NationalNo, ref string FirstName, ref string SecondName, ref string ThirdName, ref string LastName,
         ref DateTime DateOfBirth, ref int Gender, ref string Address,
         ref string Phone, ref string Email, ref int NationalityCountryID, ref string ImagePath)
        {
            bool isFound = false;
